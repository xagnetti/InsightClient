package flex.utils.spark.resize
{
    ...
    public class ResizeManager extends EventDispatcher
    {
        ...
        public function ResizeManager( resizeComponent : UIComponent = null, resizeHandle : UIComponent = null, resizeDirection : String =
            "both" )
        {
            this._enabled = true;
        ...
        private function startResize( globalX : Number, globalY : Number ) : void
        {
            ...
            var event : ResizeEvent = new ResizeEvent( RESIZE_START, false, true, resizeComponent.width, resizeComponent.
                height );
        ...
        {
            setResizeCursor();
            FlexGlobals.topLevelApplication.systemManager.addEventListener( MouseEvent.MOUSE_OUT, mouseOutResizeHandler,
                true, 0, true );
        }
        ...
        private function mouseOutResizeHandler( event : MouseEvent ) : void
        {
            ...
            {
                removeResizeCursor();
                FlexGlobals.topLevelApplication.systemManager.removeEventListener( MouseEvent.MOUSE_OUT, mouseOutResizeHandler,
                    true );
            }
        }
