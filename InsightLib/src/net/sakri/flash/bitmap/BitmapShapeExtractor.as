...
//	import flash.display.BitmapData;		
        ...
        public static function extractShapes( source_bmd : BitmapData, extraction_color : uint = 0xFF000000 ) : ExtractedShapeCollection
        {
            ...
            negative_two_color.copyChannel( temp, positive_two_color.rect, new Point(), BitmapDataChannel.BLUE, BitmapDataChannel.
                ALPHA );
        ...
        public static function extractShapesDoubleSize( source_bmd : BitmapData, extraction_color : uint = 0xFF000000, scale : Number =
            1 ) : ExtractedShapeCollection
        {
            ...
            var positive_two_color : BitmapData = new BitmapData( source_bmd.width * scale, source_bmd.height * scale, true,
                0x00 );
            ...
            temp.draw( positive_two_color );
            var negative_two_color : BitmapData = new BitmapData( positive_two_color.width, positive_two_color.height, true,
                0xFFFF0000 );
            negative_two_color.copyChannel( temp, positive_two_color.rect, new Point(), BitmapDataChannel.BLUE, BitmapDataChannel.
                ALPHA );
