package net.sakri.flash.bitmap
{
    ...
    public class ExtractedShapeCollection
    {
        ...
        public function set shapes( a : Vector.<BitmapData> ) : void
        {
            _shapes = a;
        }
        ...
        {
            return _negative_shapes;
        }

        public function set negative_shapes( a : Vector.<BitmapData> ) : void
        {
            _negative_shapes = a
        }
        ...
        {
            return _shapes.concat( _negative_shapes );
        }
