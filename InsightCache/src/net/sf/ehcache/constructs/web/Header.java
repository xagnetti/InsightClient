 ...
 * @version $Revision$
 * @param <T> The type of Header value being stored. Must implement
 *           {@link Serializable}
 */
public class Header< T extends Serializable > implements Serializable
{
   ...
   public enum Type
   {
      ...
      public static Type determineType( Class< ? extends Serializable > typeClass )
      {
         ...
         throw new IllegalArgumentException( "No Type for class "
               + typeClass );
      }
   }
   ...
   public int hashCode()
   {
      ...
      int result = 1;
      result = prime
            * result + ( ( this.name == null ) ? 0
                                              : this.name.hashCode() );
      result = prime
            * result + ( ( this.type == null ) ? 0
                                              : this.type.hashCode() );
      result = prime
            * result + ( ( this.value == null ) ? 0
                                               : this.value.hashCode() );
      return result;
   }
   ...
   {
      return "Header<"
            + this.type.getTypeClass().getSimpleName() + "> [name=" + this.name + ", value=" + this.value
            + "]";
   }
}
